...
document.addEventListener('DOMContentLoaded', () => {
  ...
  // Keeps address bar strictly clean as https://zihan.uk/
  // ------------------------------------------------------------------------
  ...
  document.addEventListener('click', (e) => {
    ...
    try {
      ...
      if (targetElement) {
        ...
        // Ensure URL stays strictly clean as https://zihan.uk/
        cleanUrlHash();
      }
    } catch (err) {}
  });
  ...
  if (aiChatBtn && aiChatWindow) {
    ...
    const AI_SYSTEM_INSTRUCTION = `You are the official Portfolio AI Assistant on Zihan Fakir's website (zihan.uk).
...
- Official Domain: https://zihan.uk
