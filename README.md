# Zihan Fakir - Professional Portfolio Website (zihan.uk)

An ultra-modern, high-performance, and fully responsive personal portfolio website for **Zihan Fakir** (`@zihanfakir`) hosted on **[zihan.uk](https://zihan.uk)** with seamless **Light & Dark Theme** switching, smooth animations, dynamic typewriter effect, interactive project showcase, and a functional contact form.

- **🌐 Domain**: [https://zihan.uk](https://zihan.uk)
